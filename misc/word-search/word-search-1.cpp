...
{
  Solution solution;
  std::vector<std::vector<char>> i1{
    {'A', 'B', 'C', 'E'},
    {'S', 'F', 'C', 'S'},
    {'A', 'D', 'E', 'E'}
  };

  std::cout << solution.exist(i1, "ABCCED") << std::endl;
  std::cout << solution.exist(i1, "SEE") << std::endl;
  std::cout << solution.exist(i1, "ABAB") << std::endl;
